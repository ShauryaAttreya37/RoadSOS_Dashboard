...
/* Stable product labels for Streamlit's file-based navigation. */
[data-testid="stSidebarNav"] a[href="/"] p,
[data-testid="stSidebarNav"] a[href="./"] p,
[data-testid="stSidebarNav"] a[href$="/PINN_Dashboard"] p,
[data-testid="stSidebarNav"] a[href$="/Nearby_Services"] p,
[data-testid="stSidebarNav"] a[href$="/Emergency_Profile"] p,
[data-testid="stSidebarNav"] a[href$="/AI_Assistant"] p,
[data-testid="stSidebarNav"] a[href$="/Live_Dashboard"] p {{
    font-size: 0 !important;
}}
[data-testid="stSidebarNav"] a[href="/"] p::after,
[data-testid="stSidebarNav"] a[href="./"] p::after,
[data-testid="stSidebarNav"] a[href$="/PINN_Dashboard"] p::after,
[data-testid="stSidebarNav"] a[href$="/Nearby_Services"] p::after,
[data-testid="stSidebarNav"] a[href$="/Emergency_Profile"] p::after,
[data-testid="stSidebarNav"] a[href$="/AI_Assistant"] p::after,
[data-testid="stSidebarNav"] a[href$="/Live_Dashboard"] p::after {{
    font-size: 0.95rem !important;
}}
[data-testid="stSidebarNav"] a[href="/"] p::after,
[data-testid="stSidebarNav"] a[href="./"] p::after {{ content: "Command Center"; }}
[data-testid="stSidebarNav"] a[href$="/PINN_Dashboard"] p::after {{ content: "Helmet Intelligence"; }}
[data-testid="stSidebarNav"] a[href$="/Nearby_Services"] p::after {{ content: "Nearby Services"; }}
[data-testid="stSidebarNav"] a[href$="/Emergency_Profile"] p::after {{ content: "Rider Profile & SOS"; }}
[data-testid="stSidebarNav"] a[href$="/AI_Assistant"] p::after {{ content: "RoadSoS AI Assistant"; }}
[data-testid="stSidebarNav"] a[href$="/Live_Dashboard"] p::after {{ content: "Live Helmet Stream"; }}
