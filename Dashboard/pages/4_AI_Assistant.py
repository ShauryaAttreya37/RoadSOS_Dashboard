...
st.set_page_config(page_title="RoadSoS | AI Assistant", page_icon="🪖", layout="wide")
inject_global_css()
init_location_state()
sidebar_brand()
render_theme_toggle()
...
<div style="display:flex;gap:12px;margin:10px 0;align-items:flex-start;">
  <div style="background:{GREEN};color:#000000;border-radius:50%;width:34px;height:34px;display:flex;
       align-items:center;justify-content:center;flex-shrink:0;font-size:1.05rem;">🤖</div>
...
page_header("🤖 RoadSoS AI Assistant", "Road safety expert · First-aid guide · Legal advisor", f"Powered by {provider_badge}", AMBER)
    ...
    for message in st.session_state.messages:
        if message["role"] == "user":
            ...
            <div style="display:flex; gap:12px; margin:5px 0; align-items:flex-start;">
              <div style="background:{GREEN}; color:#000000; border-radius:50%; width:34px; height:34px; display:flex;
                   align-items:center; justify-content:center; flex-shrink:0; font-size:1.05rem; font-weight:800; font-family:'Outfit';">🪖</div>
