...
st.set_page_config(page_title="RoadSoS | Command Center", page_icon="🪖", layout="wide", initial_sidebar_state="expanded")
inject_global_css()
init_location_state()
sidebar_brand()
render_theme_toggle()
...
""",
        ...
        st.page_link(path, label=f"Open {title}", icon="➡️", use_container_width=True)
